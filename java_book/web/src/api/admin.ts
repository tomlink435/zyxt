...
enum URL {
    ...
    startOrStop = '/api/admin/startOrStop',
...
const createApi = async (data: any) => post<any>({ url: URL.create, params: {}, data: data, });
const updateApi = async (data: any) => post<any>({ url: URL.update, data: data, });
const startOrStopApi = async (params: any) => post<any>({ url: `${URL.startOrStop}/${params.status}`, params: params, data: {}, });
const deleteApi = async (params: any) => post<any>({ url: `${URL.delete}/${params.ids}`, params: {}, headers: {} });
...
export { startOrStopApi, userLogoutApi, sendCodeApi, loginApi, listApi, detailApi, createApi, updateApi, deleteApi, userLoginApi, userRegisterApi, updateUserPwdApi, updateUserInfoApi };
